...
class ToolkitWindow(MayaQWidgetDockableMixin, QDialog):
    def __init__(self):
        super(ToolkitWindow, self).__init__()
        ...
        self.addmenu.addAction("Help on Awan's Auto Rigging Toolkit", self.openhelp)
        self.addmenu.addSeparator()
        self.addmenu.addAction("Support Me on Gumroad", self.opengumroad)
        self.addmenu.addAction("Support Me on Ko-Fi", self.openkofi)
        self.addmenu.addAction("Support Me on Sketchfab", self.opensketchfab)
        self.addmenu.addSeparator()
        self.addmenu.addAction("Developed with ❤ by awwwan", self.opengithub)
    ...
    def openhelp(self):
        web.open('https://github.com/awwwan/Auto-Rigger')

    def opengumroad(self):
        web.open('https://gumroad.com')

    def openkofi(self):
        web.open('https://ko-fi.com/')

    def opensketchfab(self):
        web.open('https://sketchfab.com/airy27/')
    
    def opengithub(self):
        web.open('https://github.com/awwwan/')
